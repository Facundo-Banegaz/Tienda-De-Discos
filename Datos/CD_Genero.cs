    ...
    public class CD_Genero
    {
        public List<Disco> listarDiscos()
        {
            ...
            try
            {
                ...
                accesoDatos.setearConsulta("select A.Id_album, A.Titulo, A.FechaLanzamiento, A.CantidadCanciones, A.UrlImagenTapa, A.Precio,T.Nombre as Edicion, G.Nombre as Genero  from Album A inner join GENERO G on  A.IdGenero = G.Id inner join TIPOSEDICION T on A.IdTipoEdicion = T.Id;");
                ...
                {
                    Disco aux = new Disco();
                    aux.Titulo = (string)accesoDatos.Lector["Id_album"];
